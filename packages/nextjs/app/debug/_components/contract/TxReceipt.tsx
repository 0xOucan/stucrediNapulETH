...
export const TxReceipt = ({ txResult }: { txResult: TransactionReceipt }) => {
  ...
  return (
    <div className="flex text-sm rounded-3xl peer-checked:rounded-b-none min-h-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 py-0">
      ...
      <div tabIndex={0} className="flex-wrap collapse collapse-arrow">
        ...
        <div className="collapse-content overflow-auto bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-t-none rounded-3xl pl-0!">
